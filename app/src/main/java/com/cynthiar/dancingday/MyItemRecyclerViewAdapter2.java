...
import com.cynthiar.dancingday.ItemFragment.OnListFragmentInteractionListener;
...
/*public class MyItemRecyclerViewAdapter2 extends RecyclerView.Adapter<MyItemRecyclerViewAdapter2.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mTimeView.setText(mValues.get(position).id);
        holder.mSchoolView.setText(mValues.get(position).content);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mSchoolView = (TextView) view.findViewById(R.id.content);
        }
